...
class Twig_Tests_Loader_FilesystemTest extends \PHPUnit\Framework\TestCase
{
    public function testGetSourceContext()
    {
        ...
        $this->assertEquals(realpath($path.'/errors/index.twig'), realpath($loader->getSourceContext('errors/index.twig')->getPath()));
    }
    ...
    public function testPaths($basePath, $cacheKey, $rootPath)
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSourceContext('index.twig')->getCode());
        $this->assertEquals("path (final)\n", $loader->getSourceContext('@__main__/index.twig')->getCode());
        $this->assertEquals("named path (final)\n", $loader->getSourceContext('@named/index.twig')->getCode());
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        $namedSource = $loader->getSourceContext('@named/index.twig')->getCode();
    ...
    public function testTemplateExistsAlwaysReturnsBool()
    {
        ...
        $this->assertTrue($loader->exists('@foo/index.twig'));
    }
}
